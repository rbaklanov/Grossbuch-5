    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 well">
                {!! Form::model($department, ['route' => ['departments.update', $department->department_id], 'class'=>'form-horizontal', 'method' => 'PUT', 'id' => 'update_department_form']) !!}
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="col-sm-6">
                                {!! Html::linkRoute('departments.show', Lang::get('departments.cancel'), [$department->department_id], ['class'=>'btn btn-primary btn-block m-r']) !!}
                            </div>
                            <div class="col-sm-6">
                                {!! Form::submit(Lang::get('departments.update'), ['class' => 'form-control btn btn-success btn-block']) !!}
                            </div>
                        </div>
                    </div>
                </div>
