    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 well">
                {!! Form::model($position, ['route' => ['positions.update', $position->position_id], 'class'=>'form-horizontal', 'method' => 'PUT', 'id' => 'update_position_form']) !!}
                {!! Form::hidden('position_id', $position->position_id) !!}
                <div class="col-sm-12">
                    ...
                    <div class="form-group @if ($errors->has('department_id')) has-error @endif">
                        {{ Form::label('department_id', Lang::get('positions.department'), ['class' => 'col-sm-4 control-label text-right', 'style']) }}
                        <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="col-sm-6">
                                {!! Html::linkRoute('positions.show', Lang::get('positions.cancel'), [$position->position_id], ['class'=>'btn btn-primary btn-block m-r']) !!}
                            </div>
                            <div class="col-sm-6">
                                {!! Form::submit(Lang::get('positions.update'), ['class' => 'form-control btn btn-success btn-block']) !!}
                            </div>
                        </div>
                    </div>
                </div>
